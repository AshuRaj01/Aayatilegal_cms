        ...
        <main class="main-content">
            ...
            <div class="content">
                <div class="page-header">
                    ...
                    <div>
                        <button onclick="CreatePost('draft')" class="btn btn-secondary">Save Draft</button>
                        <button onclick="CreatePost('publish')" class="btn btn-primary">Publish</button>
                    </div>
                </div>
                    ...
                    <div class="editor-sidebar">
                        ...
                        <div class="editor-box">
                            ...
                            <div class="featured-image">
                                ...
                                <button type="button" id="remove-featured-image" class="btn btn-secondary" style="width: 100%; margin-top: 10px; display: none;">
                                    Remove Image
                                </button>
