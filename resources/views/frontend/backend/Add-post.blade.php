...
<body>
                    ...
                    <div class="editor-sidebar">
                        ...
                        <div class="editor-box">
                            ...
                            <div class="form-group">
                                ...
                                <form id="add-category-form" style="display: none;" action="" method="post">
                                    @csrf
                                    <input type="text" id="inputCategory" class="inputCategory" placeholder="Enter category name" style="width: 100%;padding: 10px 16px;border-radius: 8px;border: 1px solid #ddd;transition: all 0.3s ease;font-size: 15px;margin-top: 19px;" />
                                    <button type="submit" class="btn btn-primary add-category-btn" style="width: 100%;margin-top: 10px;">Add</button>
                                </form>
                            </div>
                        </div>
    ...
    <!-- Scripts -->
    <script src="{{ url('backoffice/assets/js/AddPost.js') }}"></script> {{-- This Line is for Localhost --}}
    <script src="{{ url('public/backoffice/assets/js/AddPost.js') }}"></script> {{-- This Line is for Live Server --}}
